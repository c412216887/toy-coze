---
name: dify-project-handoff
description: Dify 风格 AI 工作流平台项目交接上下文，记录架构决策、当前进度、已知问题。新对话开始时使用。
---

# Dify 风格工作流平台 — 项目交接上下文

## 项目定位

面向 B 端的可视化 AI 工作流配置平台，参考 Dify 节点编排模式。用户可拖拽搭建工作流、接入多模型、使用知识库 RAG 问答。
